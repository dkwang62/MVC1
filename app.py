...
# Discount
# ----------------------------------------------------------------------
def apply_discount(points: int, disc_lvl: int = 0) -> int:
    if disc_lvl == 30:
...
# ----------------------------------------------------------------------
# Renter mode (keep your working version - not shown for brevity)
# ----------------------------------------------------------------------
# [Keep your existing renter_breakdown and compare_renter functions]

# ----------------------------------------------------------------------
# UI - FINAL, CLEAN, NO CRASH
# ----------------------------------------------------------------------
...
checkin = st.date_input("Check-in", value=datetime(2026,6,12).date(), min_value=datetime(2025,1,1).date())
...
with st.sidebar:
    ...
    if user_mode == "Owner":
        ...
        if inc_maint:
            rate = st.number_input("Maint Fee/Point ($)", 0.40, 0.80, 0.60, 0.01)
...
# Clear cache on resort/year change
...
if st.button("Calculate", type="primary"):
    ...
    if user_mode == "Owner":
        ...
        cols_to_show = ["Date", "Day", "Points", "Maintenance", "Capital", "Depreciation", room]
